...
#HPC file path
datapoints <- read.csv("/home/ahmccorm/kantar_koastore/anna/Intermediate_wheatgrass_collab/Future_2050/model_1/IWG_lat_long.csv", header=TRUE, sep=",")      #### CHANGE
head(datapoints)
...
################
#Future 2050 Models                                                                                                                          #### CHANGE
################

# Future Model 1
file_path <- "/home/ahmccorm/kantar_koastore/anna/SDM/CMIP6_2041_2060_ssp585/wc2.1_30s_bioc_ACCESS-CM2_ssp585_2041-2060.tif"
predictors <- stack(file_path)

# Future Model 2
#file_path <- "/home/ahmccorm/kantar_koastore/anna/SDM/CMIP6_2041_2060_ssp585/wc2.1_30s_bioc_BCC-CSM2-MR_ssp585_2041-2060.tif"
#predictors <- stack(file_path)

# Future Model 3
#file_path <- "/home/ahmccorm/kantar_koastore/anna/SDM/CMIP6_2041_2060_ssp585/wc2.1_30s_bioc_CMCC-ESM2_ssp585_2041-2060.tif"
#predictors <- stack(file_path)

# Future Model 4
#file_path <- "/home/ahmccorm/kantar_koastore/anna/SDM/CMIP6_2041_2060_ssp585/wc2.1_30s_bioc_EC-Earth3-Veg_ssp585_2041-2060.tif"
#predictors <- stack(file_path)

# Future Model 5
#file_path <- "/home/ahmccorm/kantar_koastore/anna/SDM/CMIP6_2041_2060_ssp585/wc2.1_30s_bioc_FIO-ESM-2-0_ssp585_2041-2060.tif"
#predictors <- stack(file_path)

# Future Model 6
#file_path <- "/home/ahmccorm/kantar_koastore/anna/SDM/CMIP6_2041_2060_ssp585/wc2.1_30s_bioc_GISS-E2-1-G_ssp585_2041-2060.tif"
#predictors <- stack(file_path)

# Future Model 7
#file_path <- "/home/ahmccorm/kantar_koastore/anna/SDM/CMIP6_2041_2060_ssp585/wc2.1_30s_bioc_HadGEM3-GC31-LL_ssp585_2041-2060.tif"
#predictors <- stack(file_path)

# Future Model 8
#file_path <- "/home/ahmccorm/kantar_koastore/anna/SDM/CMIP6_2041_2060_ssp585/wc2.1_30s_bioc_INM-CM5-0_ssp585_2041-2060.tif"
#predictors <- stack(file_path)

# Future Model 9
#file_path <- "/home/ahmccorm/kantar_koastore/anna/SDM/CMIP6_2041_2060_ssp585/wc2.1_30s_bioc_IPSL-CM6A-LR_ssp585_2041-2060.tif"
#predictors <- stack(file_path)

# Future Model 10
#file_path <- "/home/ahmccorm/kantar_koastore/anna/SDM/CMIP6_2041_2060_ssp585/wc2.1_30s_bioc_MIROC6_ssp585_2041-2060.tif"
#predictors <- stack(file_path)

# Future Model 11
#file_path <- "/home/ahmccorm/kantar_koastore/anna/SDM/CMIP6_2041_2060_ssp585/wc2.1_30s_bioc_MPI-ESM1-2-HR_ssp585_2041-2060.tif"
#predictors <- stack(file_path)

# Future Model 12
#file_path <- "/home/ahmccorm/kantar_koastore/anna/SDM/CMIP6_2041_2060_ssp585/wc2.1_30s_bioc_MRI-ESM2-0_ssp585_2041-2060.tif"
#predictors <- stack(file_path)

# Future Model 13
#file_path <- "/home/ahmccorm/kantar_koastore/anna/SDM/CMIP6_2041_2060_ssp585/wc2.1_30s_bioc_UKESM1-0-LL_ssp585_2041-2060.tif"
#predictors <- stack(file_path)
...
writeRaster(px,'/home/ahmccorm/kantar_koastore/anna/Intermediate_wheatgrass_collab/Future_2050/model_1/Future_2050_ACCESS_CM2.tif',options=c('TFW=YES'))         #### CHANGE
...
save.image(file="/home/ahmccorm/kantar_koastore/anna/Intermediate_wheatgrass_collab/Future_2050/model_1/my_workspace_model_1.RData")             #### CHANGE
